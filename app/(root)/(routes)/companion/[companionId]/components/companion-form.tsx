        ...
        >
                ...
                <FormItem className='col-span-2 md:col-span-1'>
                  ...
                  <FormControl>
                    <Input
                      ...
                      // spread field to pass on nessesary props to input (onChange, onBlue and many more)
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
              ...
              render={({ field }) => (
                <FormItem className='col-span-2 md:col-span-1'>
                  ...
                  <FormControl>
                    <Input
                      disabled={isLoading}
                      placeholder='example: CEO & Founder of Tesla, SpaceX'
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
          ...
          <div className='space-y-2 w-full'>
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                Detaild instructions for AI Behaviour
              </p>
            </div>
            <Separator className='bg-primary/10' />
          </div>
